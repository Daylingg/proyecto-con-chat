...
export const initialAlfabet = [
  { letra: 'A', select: false },
  { letra: 'B', select: false },
  { letra: 'C', select: false },
  { letra: 'D', select: false },
  { letra: 'E', select: false },
  { letra: 'F', select: false },
  { letra: 'G', select: false },
  { letra: 'H', select: false },
  { letra: 'I', select: false },
  { letra: 'J', select: false },
  { letra: 'K', select: false },
  { letra: 'L', select: false },
  { letra: 'M', select: false },
  { letra: 'N', select: false },
  { letra: 'Ñ', select: false },
  { letra: 'O', select: false },
  { letra: 'P', select: false },
  { letra: 'Q', select: false },
  { letra: 'R', select: false },
  { letra: 'S', select: false },
  { letra: 'T', select: false },
  { letra: 'U', select: false },
  { letra: 'V', select: false },
  { letra: 'W', select: false },
  { letra: 'X', select: false },
  { letra: 'Y', select: false },
  { letra: 'Z', select: false },
]
